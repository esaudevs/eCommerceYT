...
class ProductRepositoryImpl @Inject constructor(
    ...
    override suspend fun updateProductsCache(products: List<Product>, favorites: List<String>) {
        withContext(Dispatchers.IO) {
            productsDao.updateAllProducts(products = products.mapToProductEntityList(favorites))
        }
    }
